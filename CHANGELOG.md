...
## [0.0.1-nightly.20251102] - 2025-11-02

### Infrastructure
- Fixed CHANGELOG validation script to properly extract nightly build sections
- Fixed GitHub Release creation to correctly extract changelog notes from CHANGELOG.md
